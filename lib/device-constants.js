...
const DEVICE_FEATURE_TYPES = {
  ...
  BATTERY_STORAGE: {
    ...
    GRID_INPUT_ENERGY: 'grid-input-energy',
    // Cumulative grid export energy, kWh
    GRID_OUTPUT_ENERGY: 'grid-output-energy',
    // Cumulative off-grid output energy, kWh
    OFF_GRID_ENERGY: 'off-grid-energy',
