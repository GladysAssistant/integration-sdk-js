...
// The audio resolved by the onTtsSynthesize handler is bounded to 5 MB
// decoded by the Gladys core (contract B.20).
const MAX_TTS_AUDIO_SIZE = 5 * 1024 * 1024;

// Content types accepted by the Gladys core for the synthesized audio
// (contract B.20) — what Sonos/Cast/browsers actually play; the extension of
// the served URL is derived from it.
const TTS_AUDIO_CONTENT_TYPES = ['audio/mpeg', 'audio/wav', 'audio/ogg', 'audio/aac'];
