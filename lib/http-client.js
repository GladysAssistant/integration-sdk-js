const { API_PREFIX, DEFAULT_REQUEST_TIMEOUT } = require('./constants');
...
class HttpClient {
   ...
   * @param {number} [requestTimeout] - Per-request timeout in ms (default: 15000).
   * @example
   * const client = new HttpClient('http://172.30.0.1:80', 'jwt');
   */
  constructor(baseUrl, token, requestTimeout = DEFAULT_REQUEST_TIMEOUT) {
